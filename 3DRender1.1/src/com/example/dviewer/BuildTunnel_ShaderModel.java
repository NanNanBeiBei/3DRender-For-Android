...
//加载后的物体——仅携带顶点信息，颜色随机
public class BuildTunnel_ShaderModel
{	
    ...
    public BuildTunnel_ShaderModel(MySurfaceView mv,Model model)
    {    	
    	//初始化顶点坐标与着色数据
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("tunnelvertex", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("tunnelfrag", mv.getResources());  
        //基于顶点着色器与片元着色器创建程序
