...
//加载后的物体——仅携带顶点信息，颜色随机
public class BuildTwist_ShaderModel
{	
	...
	//float timeofSecond = time/1000; //mtime 为秒 
    ...
    public BuildTwist_ShaderModel(MySurfaceView mv,Model model)
    {    	
    	//初始化顶点坐标与着色数据
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("twistvertex", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("twistfrag", mv.getResources());  
        //基于顶点着色器与片元着色器创建程序
